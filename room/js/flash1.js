            ...
            switch (cbkFuncName) {
                ...
                case "OnUserIn":
                    ...
                    for (var i = 0; i < userList.length; i++) {
                        if (userList[i].userName != "checker" && userList[i].userType==1) {
                ...
                case "OnUserOut":
                    ...
                    for (var i = 0; i < userList.length; i++) {
                        ...
                        if (userList[i].peerID == outUserID) {
                            ...
                            if(userList[i].userType == 1 && userList[i].userName != 'checker'){
                           var div =  $('<div>').css({
                                'width':$("#video_slave").width(),
                                'height':$("#video_slave").height(),
                                'position':'absolute',
                            ...
                            }).addClass('video_slaveCover').append($('<p></p>').html('<br/><br/><br/><br/>断开连接<br/>Disconnection').css({
                                'color':'#fff',
                                'height':$("#video_slave").height(),
                                'text-align':'center',
                                'font-size':'22px'
